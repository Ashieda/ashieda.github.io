...
gEngine.Core.inheritPrototype(ThirdScene, Scene);

ThirdScene.prototype.loadScene = function () {
    // loads the textures
    gEngine.Textures.loadTexture(this.dirtTexture);
    gEngine.Textures.loadTexture(this.stoneTexture);
    gEngine.Textures.loadTexture(this.grassTexture);
    gEngine.Textures.loadTexture(this.lavaTexture);
    gEngine.Textures.loadTexture(this.diamondTexture);
};

ThirdScene.prototype.unloadScene = function () {
    ...
    gEngine.Textures.unloadTexture(this.grassTexture);
    gEngine.Textures.unloadTexture(this.lavaTexture);
...
ThirdScene.prototype.draw = function () {
...
ThirdScene.prototype.update = function () {
  if (gEngine.Input.isKeyClicked(gEngine.Input.keys.Space))
  {
    var arrOfLayers = [this.lavaTexture,
                       this.diamondTexture,
                       this.stoneTexture,
                       this.dirtTexture,
                       this.grassTexture];
